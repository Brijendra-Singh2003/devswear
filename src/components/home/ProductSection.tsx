...
export default async function Collection({
  ...
  return (
    <section className="flex mt-1 flex-col w-full sm:my-4 z-8 bg-popover shadow">
      <div className="pt-4 px-4 capitalize sm:text-3xl text-xl relative flex justify-between">
        <h2>{title}</h2>
      </div>
        ...
        {products.map((item) => {
          return (
            ...
            >
              ...
              <p className="flex px-2 flex-wrap space-x-1 items-center">
